...
+ teams reviewing multi-tenant backend design
+ founders building SaaS apps on Supabase
+ engineers debugging RLS and auth-context issues
+ clients who want a focused security review of an existing Supabase backend
